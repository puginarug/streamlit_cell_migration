...
if st.sidebar.button("Run Simulation"):
    ...
    sns.scatterplot(x=time_array[:], y=MSD[:], color="teal", ax=ax_msd, s=30, edgecolor="teal")
    ...
    sns.scatterplot(x=np.arange(len(autocorr)), y=autocorr, color="teal", ax=ax_auto, s=30, edgecolor="teal")
